...
def startdocker():
    os.popen('systemctl start acunetix.service ')
    exit()

def stopdocker():
    os.popen('systemctl stop acunetix.service ')
    exit()

win = Tk()
win.title("Acunetix Servies")
win.geometry("400x190")
win.resizable(FALSE,FALSE)
p1 = PhotoImage(file = '/home/dhirajarya/Softwares/acunetix/logo.png')   
win.iconphoto(False, p1)

image=Image.open('/home/dhirajarya/Softwares/acunetix/img.png')
